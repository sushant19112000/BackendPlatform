...
async function ifYesOptinMailer(email, firstname) {
  ...
  <tbody>
    ...
    <tr>
      <td align="left" valign="top" style="font-family: 'Lato', sans-serif; font-size: 12px; color: #343434; line-height: 18px;">
			<p>Thank you for completing the survey and for your interest in a meeting with Oracle during GITEX. An Oracle representative will be in touch to arrange this. You will also receive a copy of the report once published.
            </p>
...
<tr>
<td style="font-size: 11px; font-family: 'Lato', sans-serif; color: #343434;" align="center">This email was sent to .</td>
</tr>
<tr>
...
module.exports = ifYesOptinMailer;
